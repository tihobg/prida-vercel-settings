...
from . models import (Patients, PatientProba, Score, Prida, Person, PridaMutations, PridaControli, PridaPreeclampsia,
                      PridaPreeclampsiaCorrelation, PridaMutations2)
...
admin.site.register(PridaPreeclampsiaCorrelation, ImportExportModelAdmin)
